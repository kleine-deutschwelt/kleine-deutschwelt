const colors = [
  {
    ...
    ro: "roșu",
    hex: "#e53935",
    audio: "../audio/farben/words/rot.mp3"
  },
  {
    de: "blau",
    ro: "albastru",
    hex: "#3297db",
    audio: "../audio/farben/words/blau.mp3"
  },
  {
    de: "gelb",
    ro: "galben",
    hex: "#f7cf36",
    audio: "../audio/farben/words/gelb.mp3"
  },
  {
    de: "grün",
    ro: "verde",
    hex: "#55ad5b",
    audio: "../audio/farben/words/gruen.mp3"
  },
  {
    de: "orange",
    ro: "portocaliu",
    hex: "#f28b30",
    audio: "../audio/farben/words/orange.mp3"
  },
  {
    de: "lila",
    ro: "violet",
    hex: "#9b6bc3",
    audio: "../audio/farben/words/lila.mp3"
  },
  {
    de: "rosa",
    ro: "roz",
    hex: "#f39abd",
    audio: "../audio/farben/words/rosa.mp3"
  },
  {
    de: "braun",
    ro: "maro",
    hex: "#8b5a3c",
    audio: "../audio/farben/words/braun.mp3"
  },
  {
    de: "schwarz",
    ro: "negru",
    hex: "#252525",
    audio: "../audio/farben/words/schwarz.mp3"
  },
  {
    de: "weiß",
    ro: "alb",
    hex: "#f8f8f3",
    audio: "../audio/farben/words/weiss.mp3"
  }
];

const examples = [
  {
    image: "../assets/images/lessons/farben/examples/apfel-rot.webp",
    de: "Der Apfel ist rot.",
    ro: "Mărul este roșu.",
    audio: "../audio/farben/examples/apfel-rot.mp3"
  },
  {
    image: "../assets/images/lessons/farben/examples/auto-blau.webp",
    de: "Das Auto ist blau.",
    ro: "Mașina este albastră.",
    audio: "../audio/farben/examples/auto-blau.mp3"
  },
  {
    image: "../assets/images/lessons/farben/examples/sonne-gelb.webp",
    de: "Die Sonne ist gelb.",
    ro: "Soarele este galben.",
    audio: "../audio/farben/examples/sonne-gelb.mp3"
  },
  {
    image: "../assets/images/lessons/farben/examples/blatt-gruen.webp",
    de: "Das Blatt ist grün.",
    ro: "Frunza este verde.",
    audio: "../audio/farben/examples/blatt-gruen.mp3"
  },
  {
    image: "../assets/images/lessons/farben/examples/karotte-orange.webp",
    de: "Die Karotte ist orange.",
    ro: "Morcovul este portocaliu.",
    audio: "../audio/farben/examples/karotte-orange.mp3"
  },
  {
    image: "../assets/images/lessons/farben/examples/luftballon-lila.webp",
    de: "Der Luftballon ist lila.",
    ro: "Balonul este violet.",
    audio: "../audio/farben/examples/luftballon-lila.mp3"
  },
  {
    image: "../assets/images/lessons/farben/examples/blume-rosa.webp",
    de: "Die Blume ist rosa.",
    ro: "Floarea este roz.",
    audio: "../audio/farben/examples/blume-rosa.mp3"
  },
  {
    image: "../assets/images/lessons/farben/examples/baer-braun.webp",
    de: "Der Bär ist braun.",
    ro: "Ursul este maro.",
    audio: "../audio/farben/examples/baer-braun.mp3"
  },
  {
    image: "../assets/images/lessons/farben/examples/katze-schwarz.webp",
    de: "Die Katze ist schwarz.",
    ro: "Pisica este neagră.",
    audio: "../audio/farben/examples/katze-schwarz.mp3"
  },
  {
    image: "../assets/images/lessons/farben/examples/kaninchen-weiss.webp",
    de: "Das Kaninchen ist weiß.",
    ro: "Iepurele este alb.",
    audio: "../audio/farben/examples/kaninchen-weiss.mp3"
  }
];
    ...
    (item) => `
      <article class="example-card">
        ...
        <button
          ...
          aria-label="Ascultă propoziția ${item.de}"
        >
          🔊
        </button>
      </article>
...
/* Activitatea 1: alegerea culorii soarelui */
...
/* Activitatea 2: completarea propozițiilor */
...
/* Activitatea 3: alegerea obiectului roșu */
...
/* Deblocarea butonului după cele 3 activități */
...
/* Închiderea diplomei cu tasta Escape */
